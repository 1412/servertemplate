...
function LOGGER(context, category){
    ...
    this.__proto__.displayPrompt = function(){
        if (this._context.REPL !== undefined) {
            if (this._context.REPL.Client !== undefined) {
                for (var i in this._context.REPL.Client) {
                    if (this._context.REPL.Client[i].displayPrompt !== undefined) {
                        this._context.REPL.Client[i].displayPrompt();
                    }
                }
            }
        }
